# -*- coding: utf-8 -*-
"""
Created on Thu Oct 10 16:10:02 2019
...
def RV2(filename):
    ...
    procdata = [Name[0], Name[1], Sdate[0], "1","Vibhav","nan", "nan", pid[0], bdate[0], 
                ...
                LV3D[2], LV3D[8], LVSax[1], LVSax[7], LV3D[1], LV3D[7], LVSax[0], 
                LVLax[0], LVSax[6], LVLax[6], LV3D[0], LV3D[6], LVTorsion, RVLax[2], 
                RVLax[8],RV3DLong[0], RV3DLong[1], RVSax[1], RVSax[7], RV3DCircum[0], 
                RV3DCircum[1], RVSax[0], RVLax[0], RVSax[6], RVLax[6], RV3DRadial[0], 
